                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          SocialSharePro.shareInstagramStory(
                            appId: facebookId,
                            imagePath: path,
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          SocialSharePro.shareFacebookStory(
                            appId: facebookId,
                            imagePath: path,
                            backgroundTopColor: "#ffffff",
                            backgroundBottomColor: "#000000",
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          await SocialSharePro.shareFacebookStory(
                            appId: facebookId,
                            imagePath: path,
                            backgroundResourcePath: videoBackgroundPath,
                          ).then((data) {
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton(
                        child: Icon(Icons.image),
                        onPressed: () async {
                          SocialSharePro.copyToClipboard(
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton(
                        child: Icon(Icons.text_fields),
                        onPressed: () async {
                          SocialSharePro.shareOptions("Hello world").then((data) {
                            print(data);
                          });
                        },
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton(
                        child: Icon(Icons.text_fields),
                        onPressed: () async {
                          SocialSharePro.checkInstalledAppsForShare().then((data) {
                            print(data.toString());
                          });
                        },
                      ),
